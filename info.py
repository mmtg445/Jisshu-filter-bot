...
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6976744562 8102446291 7534546565').split()]
USERNAME = environ.get('USERNAME', "RahatVx") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002419150355'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+Wwm4Jjrs8F44OTc1')
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002298027769')
