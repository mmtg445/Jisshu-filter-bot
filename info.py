...
USERNAME = environ.get('USERNAME', "https://t.me/Rahat146Tm") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002162182935'))
...
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002329322641'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002282029638') # If anyone sends a request message to your bot, you will get it in this channel.
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '1002198886089')) # 
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://ibb.co/fdGkZPG https://ibb.co/bshQysJ https://ibb.co/bshQysJ')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://ibb.co/bshQysJ')
